...
";
    ...
    public async Task HandleCRD()
    {
        ...
        //await testHarness.Cluster.IsResourceReady<V1CustomResourceDefinition>(CancellationToken.None);
...
";
        ...
        var _seedMethodInfo = testHarness.Cluster.GetType().GetMethod(nameof(Cluster.Seed));
