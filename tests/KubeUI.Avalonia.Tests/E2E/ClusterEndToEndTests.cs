...
";
    ...
    private static async Task<T?> WaitForResourceAsync<T>(IClusterRuntime cluster, string? @namespace, string name, TimeSpan? timeout = null, int pollIntervalMs = 100) where T : class, IKubernetesObject<V1ObjectMeta>, new()
    {
