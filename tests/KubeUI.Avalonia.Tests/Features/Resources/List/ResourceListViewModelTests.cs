...
public class ResourceListViewModelTests : AvaloniaTestBase
{
    ...
    public async Task resource_list_filter_flyout_rows_align_editors()
    {
        ...
        var dateColumn = dateVm.ColumnDefinitions.First(column => string.Equals(column.Header?.ToString(), "Last_Seen", StringComparison.Ordinal));
    ...
    public async Task resource_list_numeric_and_date_filters_support_comparison_operators()
    {
        ...
        var lastSeenColumn = vm.ColumnDefinitions.First(column => string.Equals(column.Header?.ToString(), "Last_Seen", StringComparison.Ordinal));
    ...
    public async Task resource_list_filters_update_the_live_view()
    {
        ...
        var lastSeenColumn = countVm.ColumnDefinitions.First(column => string.Equals(column.Header?.ToString(), "Last_Seen", StringComparison.Ordinal));
