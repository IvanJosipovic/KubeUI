...
public partial class ListComponent2<TItem> : ListBase<TItem>, IDisposable where TItem : class, IKubernetesObject<V1ObjectMeta>, new()
{
    ...
    private List<ColumnComponent2<TItem>> Columns { get; set; } = new List<ColumnComponent2<TItem>>();
    ...
    public void AddColumn(ColumnComponent2<TItem> column)
    {
        Columns.Add(column);
    }
    ...
    public List<ColumnComponent2<TItem>> GetColumns()
    {
        return Columns;
    }
