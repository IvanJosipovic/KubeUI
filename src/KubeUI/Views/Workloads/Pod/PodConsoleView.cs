...
public sealed class PodConsoleView : MyViewBase<PodConsoleViewModel>
{
            ...
            .Children([
                    ...
                    .Children([
                        ...
                        new Label()
                            ...
                            .Content(new MultiBinding(){
                                Bindings = [
                                    Utilities.FuncBinding<PodConsoleViewModel>(x => x.Object.Metadata.NamespaceProperty),
                                    Utilities.FuncBinding<PodConsoleViewModel>(x => x.Object.Metadata.Name),
                                    Utilities.FuncBinding<PodConsoleViewModel>(x => x.ContainerName),
                                ],
                                StringFormat = "{0}/{1}/{2}"
                            }),
                        //new Label()
                ...
                new TextEditor()
                    ...
                    .Set(x => {
                        ...
                        // Add Coloring
                        x.TextArea.TextView.LineTransformers.Add(new ConsoleColorizer(vm.Terminal));
    ...
    protected override void OnAttachedToVisualTree(VisualTreeAttachmentEventArgs e)
    {
        ...
        try
        {
            ...
            ViewModel?.Resize(_textEditor.Bounds.Width, _textEditor.Bounds.Height);
        }
        catch (Exception ex)
        {
