...
public static T NeedsConfirmation<TValue,T>(this T control, TValue value, FuncValueConverter<TValue, System.Boolean> converter, BindingMode? bindingMode = null, object? bindingSource = null, [CallerArgumentExpression("value")] string? ps = null) where T : Ursa.Controls.TimePickerPresenter 
...
/*MagicalSetterWithConverterGenerator*/
public static T MinuteIncrement<TValue,T>(this T control, TValue value, FuncValueConverter<TValue, System.Int32> converter, BindingMode? bindingMode = null, object? bindingSource = null, [CallerArgumentExpression("value")] string? ps = null) where T : Ursa.Controls.TimePickerPresenter 
...
/*MagicalSetterWithConverterGenerator*/
public static T SecondIncrement<TValue,T>(this T control, TValue value, FuncValueConverter<TValue, System.Int32> converter, BindingMode? bindingMode = null, object? bindingSource = null, [CallerArgumentExpression("value")] string? ps = null) where T : Ursa.Controls.TimePickerPresenter 
...
/*MagicalSetterWithConverterGenerator*/
public static T PanelFormat<TValue,T>(this T control, TValue value, FuncValueConverter<TValue, System.String> converter, BindingMode? bindingMode = null, object? bindingSource = null, [CallerArgumentExpression("value")] string? ps = null) where T : Ursa.Controls.TimePickerPresenter 
...
public static T OnSelectedTimeChanged<T>(this T control, Action<Ursa.Controls.TimeChangedEventArgs> action, Avalonia.Interactivity.RoutingStrategies routes = Avalonia.Interactivity.RoutingStrategies.Tunnel | Avalonia.Interactivity.RoutingStrategies.Bubble) where T : Ursa.Controls.TimePickerPresenter 
{
  control.AddHandler(Ursa.Controls.TimePickerPresenter.SelectedTimeChangedEvent, (_, args) => action(args), routes);
  return control; 
}
