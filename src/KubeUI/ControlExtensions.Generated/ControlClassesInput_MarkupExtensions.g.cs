...
public static T Target<TValue,T>(this T control, TValue value, FuncValueConverter<TValue, Avalonia.Controls.Control> converter, BindingMode? bindingMode = null, object? bindingSource = null, [CallerArgumentExpression("value")] string? ps = null) where T : Ursa.Controls.ControlClassesInput 
...
/*MagicalSetterWithConverterGenerator*/
public static T Separator<TValue,T>(this T control, TValue value, FuncValueConverter<TValue, System.String> converter, BindingMode? bindingMode = null, object? bindingSource = null, [CallerArgumentExpression("value")] string? ps = null) where T : Ursa.Controls.ControlClassesInput 
...
public static T ControlClassesInput_Source<T>(this T control, Ursa.Controls.ControlClassesInput value, BindingMode? bindingMode = null, IValueConverter? converter = null, object? bindingSource = null, [CallerArgumentExpression("value")] string? ps = null) where T : Avalonia.StyledElement
...
public static T ControlClassesInput_Source<T>(this T control, Func<Ursa.Controls.ControlClassesInput> func, Action<Ursa.Controls.ControlClassesInput>? onChanged = null, [CallerArgumentExpression("func")] string? expression = null) where T : Avalonia.StyledElement 
