...
public sealed class PodMetricsControl : MyViewBase<V1Pod>, IInitializeCluster
{
    public ICluster Cluster { get; set; }

    private static readonly DispatcherTimer s_timer = new(DispatcherPriority.Default);

    public PodMetricsControl()
    {
    ...
    public static readonly DirectProperty<PodMetricsControl, string> PrettyStringProperty =
    AvaloniaProperty.RegisterDirect<PodMetricsControl, string>(
    nameof(PrettyString),
    o => o.PrettyString,
