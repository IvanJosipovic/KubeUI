...
public sealed partial class VisualizationViewModel : ViewModelBase, IInitializeCluster, IDisposable
{
    ...
    [ObservableProperty]
    public partial NodifyEditorViewModelBase NodifyEditor { get; set; } = new();
    ...
    private void Clear()
    {
        NodifyEditor.Nodes.Clear();
        NodifyEditor.Connections.Clear();
    }
    ...
    private void PopulateAllResources()
    {
        ...
        foreach (var kind in Cluster.Objects)
        {
            ...
            foreach (object item in (IList)items.GetType().GetProperty("Items").GetValue(items))
            {
                ...
                NodifyEditor.Nodes.Add(resource);
            }
        }
    }
    ...
    public ResourceNodeViewModel CreateResource(IKubernetesObject<V1ObjectMeta> resource, GroupApiVersionKind kind, double pinSize = 8)
    {
    ...
    public sealed partial class ResourceNodeViewModel : NodeViewModelBase
    {
        [ObservableProperty]
        ...
        [ObservableProperty]
        public partial ConnectorViewModelBase InputConnector { get; set; } = new() { Flow = ConnectorViewModelBase.ConnectorFlow.Input };

        [ObservableProperty]
        public partial ConnectorViewModelBase OutputConnector { get; set; } = new() { Flow = ConnectorViewModelBase.ConnectorFlow.Output };
    }
