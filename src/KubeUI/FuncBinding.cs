...
internal class FuncBinding<T> : Binding
{
    public FuncBinding(Func<T, object> func, [CallerArgumentExpression(nameof(func))] string? expression = null)
    {
        Path = PropertyPathHelper.GetNameFromPropertyPath(expression);
    }
}
