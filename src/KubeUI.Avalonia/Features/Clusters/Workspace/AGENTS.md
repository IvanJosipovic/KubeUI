...
- CRD add, update, and delete events update workspace resource configs, GVK catalog entries, and seeded informers.
...
- Events exist so downstream UI can update incrementally.
