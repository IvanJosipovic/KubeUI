...
public static T SyncContext<TValue,T>(this T control, TValue value, FuncValueConverter<TValue, System.Object> converter, BindingMode? bindingMode = null, object? bindingSource = null, [CallerArgumentExpression("value")] string? ps = null) where T : LiveChartsCore.SkiaSharpView.Avalonia.PolarChart 
...
/*BindFromExpressionSetterGenerator*/
public static T Title<T>(this T control, Func<LiveChartsCore.VisualElements.VisualElement> func, Action<LiveChartsCore.VisualElements.VisualElement>? onChanged = null, [CallerArgumentExpression("func")] string? expression = null) where T : LiveChartsCore.SkiaSharpView.Avalonia.PolarChart 
   => control._set(LiveChartsCore.SkiaSharpView.Avalonia.PolarChart.TitleProperty, func, onChanged, expression);

/*MagicalSetterGenerator*/
public static T Title<T>(this T control,LiveChartsCore.VisualElements.VisualElement value, BindingMode? bindingMode = null, IValueConverter? converter = null, object? bindingSource = null, [CallerArgumentExpression("value")] string? ps = null) where T : LiveChartsCore.SkiaSharpView.Avalonia.PolarChart 
...
/*MagicalSetterWithConverterGenerator*/
public static T Title<TValue,T>(this T control, TValue value, FuncValueConverter<TValue, LiveChartsCore.VisualElements.VisualElement> converter, BindingMode? bindingMode = null, object? bindingSource = null, [CallerArgumentExpression("value")] string? ps = null) where T : LiveChartsCore.SkiaSharpView.Avalonia.PolarChart 
...
/*MagicalSetterWithConverterGenerator*/
public static T FitToBounds<TValue,T>(this T control, TValue value, FuncValueConverter<TValue, System.Boolean> converter, BindingMode? bindingMode = null, object? bindingSource = null, [CallerArgumentExpression("value")] string? ps = null) where T : LiveChartsCore.SkiaSharpView.Avalonia.PolarChart 
...
/*MagicalSetterWithConverterGenerator*/
public static T TotalAngle<TValue,T>(this T control, TValue value, FuncValueConverter<TValue, System.Double> converter, BindingMode? bindingMode = null, object? bindingSource = null, [CallerArgumentExpression("value")] string? ps = null) where T : LiveChartsCore.SkiaSharpView.Avalonia.PolarChart 
...
/*MagicalSetterWithConverterGenerator*/
public static T InnerRadius<TValue,T>(this T control, TValue value, FuncValueConverter<TValue, System.Double> converter, BindingMode? bindingMode = null, object? bindingSource = null, [CallerArgumentExpression("value")] string? ps = null) where T : LiveChartsCore.SkiaSharpView.Avalonia.PolarChart 
...
/*MagicalSetterWithConverterGenerator*/
public static T InitialRotation<TValue,T>(this T control, TValue value, FuncValueConverter<TValue, System.Double> converter, BindingMode? bindingMode = null, object? bindingSource = null, [CallerArgumentExpression("value")] string? ps = null) where T : LiveChartsCore.SkiaSharpView.Avalonia.PolarChart 
...
/*MagicalSetterWithConverterGenerator*/
public static T AnimationsSpeed<TValue,T>(this T control, TValue value, FuncValueConverter<TValue, System.TimeSpan> converter, BindingMode? bindingMode = null, object? bindingSource = null, [CallerArgumentExpression("value")] string? ps = null) where T : LiveChartsCore.SkiaSharpView.Avalonia.PolarChart 
...
/*BindFromExpressionSetterGenerator*/
public static T TooltipBackgroundPaint<T>(this T control, Func<LiveChartsCore.Painting.Paint> func, Action<LiveChartsCore.Painting.Paint>? onChanged = null, [CallerArgumentExpression("func")] string? expression = null) where T : LiveChartsCore.SkiaSharpView.Avalonia.PolarChart 
   => control._set(LiveChartsCore.SkiaSharpView.Avalonia.PolarChart.TooltipBackgroundPaintProperty, func, onChanged, expression);

/*MagicalSetterGenerator*/
public static T TooltipBackgroundPaint<T>(this T control,LiveChartsCore.Painting.Paint value, BindingMode? bindingMode = null, IValueConverter? converter = null, object? bindingSource = null, [CallerArgumentExpression("value")] string? ps = null) where T : LiveChartsCore.SkiaSharpView.Avalonia.PolarChart 
...
/*MagicalSetterWithConverterGenerator*/
public static T TooltipBackgroundPaint<TValue,T>(this T control, TValue value, FuncValueConverter<TValue, LiveChartsCore.Painting.Paint> converter, BindingMode? bindingMode = null, object? bindingSource = null, [CallerArgumentExpression("value")] string? ps = null) where T : LiveChartsCore.SkiaSharpView.Avalonia.PolarChart 
...
/*BindFromExpressionSetterGenerator*/
public static T TooltipTextPaint<T>(this T control, Func<LiveChartsCore.Painting.Paint> func, Action<LiveChartsCore.Painting.Paint>? onChanged = null, [CallerArgumentExpression("func")] string? expression = null) where T : LiveChartsCore.SkiaSharpView.Avalonia.PolarChart 
   => control._set(LiveChartsCore.SkiaSharpView.Avalonia.PolarChart.TooltipTextPaintProperty, func, onChanged, expression);

/*MagicalSetterGenerator*/
public static T TooltipTextPaint<T>(this T control,LiveChartsCore.Painting.Paint value, BindingMode? bindingMode = null, IValueConverter? converter = null, object? bindingSource = null, [CallerArgumentExpression("value")] string? ps = null) where T : LiveChartsCore.SkiaSharpView.Avalonia.PolarChart 
...
/*MagicalSetterWithConverterGenerator*/
public static T TooltipTextPaint<TValue,T>(this T control, TValue value, FuncValueConverter<TValue, LiveChartsCore.Painting.Paint> converter, BindingMode? bindingMode = null, object? bindingSource = null, [CallerArgumentExpression("value")] string? ps = null) where T : LiveChartsCore.SkiaSharpView.Avalonia.PolarChart 
...
/*BindFromExpressionSetterGenerator*/
public static T TooltipTextSize<T>(this T control, Func<System.Double> func, Action<System.Double>? onChanged = null, [CallerArgumentExpression("func")] string? expression = null) where T : LiveChartsCore.SkiaSharpView.Avalonia.PolarChart 
   => control._set(LiveChartsCore.SkiaSharpView.Avalonia.PolarChart.TooltipTextSizeProperty, func, onChanged, expression);

/*MagicalSetterGenerator*/
public static T TooltipTextSize<T>(this T control,System.Double value, BindingMode? bindingMode = null, IValueConverter? converter = null, object? bindingSource = null, [CallerArgumentExpression("value")] string? ps = null) where T : LiveChartsCore.SkiaSharpView.Avalonia.PolarChart 
...
/*MagicalSetterWithConverterGenerator*/
public static T TooltipTextSize<TValue,T>(this T control, TValue value, FuncValueConverter<TValue, System.Double> converter, BindingMode? bindingMode = null, object? bindingSource = null, [CallerArgumentExpression("value")] string? ps = null) where T : LiveChartsCore.SkiaSharpView.Avalonia.PolarChart 
...
/*MagicalSetterWithConverterGenerator*/
public static T LegendPosition<TValue,T>(this T control, TValue value, FuncValueConverter<TValue, LiveChartsCore.Measure.LegendPosition> converter, BindingMode? bindingMode = null, object? bindingSource = null, [CallerArgumentExpression("value")] string? ps = null) where T : LiveChartsCore.SkiaSharpView.Avalonia.PolarChart 
...
/*BindFromExpressionSetterGenerator*/
public static T LegendBackgroundPaint<T>(this T control, Func<LiveChartsCore.Painting.Paint> func, Action<LiveChartsCore.Painting.Paint>? onChanged = null, [CallerArgumentExpression("func")] string? expression = null) where T : LiveChartsCore.SkiaSharpView.Avalonia.PolarChart 
   => control._set(LiveChartsCore.SkiaSharpView.Avalonia.PolarChart.LegendBackgroundPaintProperty, func, onChanged, expression);

/*MagicalSetterGenerator*/
public static T LegendBackgroundPaint<T>(this T control,LiveChartsCore.Painting.Paint value, BindingMode? bindingMode = null, IValueConverter? converter = null, object? bindingSource = null, [CallerArgumentExpression("value")] string? ps = null) where T : LiveChartsCore.SkiaSharpView.Avalonia.PolarChart 
...
/*MagicalSetterWithConverterGenerator*/
public static T LegendBackgroundPaint<TValue,T>(this T control, TValue value, FuncValueConverter<TValue, LiveChartsCore.Painting.Paint> converter, BindingMode? bindingMode = null, object? bindingSource = null, [CallerArgumentExpression("value")] string? ps = null) where T : LiveChartsCore.SkiaSharpView.Avalonia.PolarChart 
...
/*BindFromExpressionSetterGenerator*/
public static T LegendTextPaint<T>(this T control, Func<LiveChartsCore.Painting.Paint> func, Action<LiveChartsCore.Painting.Paint>? onChanged = null, [CallerArgumentExpression("func")] string? expression = null) where T : LiveChartsCore.SkiaSharpView.Avalonia.PolarChart 
   => control._set(LiveChartsCore.SkiaSharpView.Avalonia.PolarChart.LegendTextPaintProperty, func, onChanged, expression);

/*MagicalSetterGenerator*/
public static T LegendTextPaint<T>(this T control,LiveChartsCore.Painting.Paint value, BindingMode? bindingMode = null, IValueConverter? converter = null, object? bindingSource = null, [CallerArgumentExpression("value")] string? ps = null) where T : LiveChartsCore.SkiaSharpView.Avalonia.PolarChart 
...
/*MagicalSetterWithConverterGenerator*/
public static T LegendTextPaint<TValue,T>(this T control, TValue value, FuncValueConverter<TValue, LiveChartsCore.Painting.Paint> converter, BindingMode? bindingMode = null, object? bindingSource = null, [CallerArgumentExpression("value")] string? ps = null) where T : LiveChartsCore.SkiaSharpView.Avalonia.PolarChart 
...
/*BindFromExpressionSetterGenerator*/
public static T LegendTextSize<T>(this T control, Func<System.Double> func, Action<System.Double>? onChanged = null, [CallerArgumentExpression("func")] string? expression = null) where T : LiveChartsCore.SkiaSharpView.Avalonia.PolarChart 
   => control._set(LiveChartsCore.SkiaSharpView.Avalonia.PolarChart.LegendTextSizeProperty, func, onChanged, expression);

/*MagicalSetterGenerator*/
public static T LegendTextSize<T>(this T control,System.Double value, BindingMode? bindingMode = null, IValueConverter? converter = null, object? bindingSource = null, [CallerArgumentExpression("value")] string? ps = null) where T : LiveChartsCore.SkiaSharpView.Avalonia.PolarChart 
...
/*MagicalSetterWithConverterGenerator*/
public static T LegendTextSize<TValue,T>(this T control, TValue value, FuncValueConverter<TValue, System.Double> converter, BindingMode? bindingMode = null, object? bindingSource = null, [CallerArgumentExpression("value")] string? ps = null) where T : LiveChartsCore.SkiaSharpView.Avalonia.PolarChart 
...
/*MagicalSetterWithConverterGenerator*/
public static T UpdateStartedCommand<TValue,T>(this T control, TValue value, FuncValueConverter<TValue, System.Windows.Input.ICommand> converter, BindingMode? bindingMode = null, object? bindingSource = null, [CallerArgumentExpression("value")] string? ps = null) where T : LiveChartsCore.SkiaSharpView.Avalonia.PolarChart 
...
/*MagicalSetterWithConverterGenerator*/
public static T PointerPressedCommand<TValue,T>(this T control, TValue value, FuncValueConverter<TValue, System.Windows.Input.ICommand> converter, BindingMode? bindingMode = null, object? bindingSource = null, [CallerArgumentExpression("value")] string? ps = null) where T : LiveChartsCore.SkiaSharpView.Avalonia.PolarChart 
...
/*MagicalSetterWithConverterGenerator*/
public static T PointerReleasedCommand<TValue,T>(this T control, TValue value, FuncValueConverter<TValue, System.Windows.Input.ICommand> converter, BindingMode? bindingMode = null, object? bindingSource = null, [CallerArgumentExpression("value")] string? ps = null) where T : LiveChartsCore.SkiaSharpView.Avalonia.PolarChart 
...
/*MagicalSetterWithConverterGenerator*/
public static T PointerMoveCommand<TValue,T>(this T control, TValue value, FuncValueConverter<TValue, System.Windows.Input.ICommand> converter, BindingMode? bindingMode = null, object? bindingSource = null, [CallerArgumentExpression("value")] string? ps = null) where T : LiveChartsCore.SkiaSharpView.Avalonia.PolarChart 
...
/*MagicalSetterWithConverterGenerator*/
public static T DataPointerDownCommand<TValue,T>(this T control, TValue value, FuncValueConverter<TValue, System.Windows.Input.ICommand> converter, BindingMode? bindingMode = null, object? bindingSource = null, [CallerArgumentExpression("value")] string? ps = null) where T : LiveChartsCore.SkiaSharpView.Avalonia.PolarChart 
...
/*BindFromExpressionSetterGenerator*/
public static T HoveredPointsChangedCommand<T>(this T control, Func<System.Windows.Input.ICommand> func, Action<System.Windows.Input.ICommand>? onChanged = null, [CallerArgumentExpression("func")] string? expression = null) where T : LiveChartsCore.SkiaSharpView.Avalonia.PolarChart 
   => control._set(LiveChartsCore.SkiaSharpView.Avalonia.PolarChart.HoveredPointsChangedCommandProperty, func, onChanged, expression);

/*MagicalSetterGenerator*/
public static T HoveredPointsChangedCommand<T>(this T control,System.Windows.Input.ICommand value, BindingMode? bindingMode = null, IValueConverter? converter = null, object? bindingSource = null, [CallerArgumentExpression("value")] string? ps = null) where T : LiveChartsCore.SkiaSharpView.Avalonia.PolarChart 
=> control._setEx(LiveChartsCore.SkiaSharpView.Avalonia.PolarChart.HoveredPointsChangedCommandProperty, ps, () => control.HoveredPointsChangedCommand = value, bindingMode, converter, bindingSource);

/*BindSetterGenerator*/
public static T HoveredPointsChangedCommand<T>(this T control, IBinding binding) where T : LiveChartsCore.SkiaSharpView.Avalonia.PolarChart 
   => control._set(LiveChartsCore.SkiaSharpView.Avalonia.PolarChart.HoveredPointsChangedCommandProperty, binding);

/*AvaloniaPropertyBindSetterGenerator*/
public static T HoveredPointsChangedCommand<T>(this T control, AvaloniaProperty avaloniaProperty, BindingMode? bindingMode = null, IValueConverter? converter = null, ViewBase? overrideView = null) where T : LiveChartsCore.SkiaSharpView.Avalonia.PolarChart 
   => control._set(LiveChartsCore.SkiaSharpView.Avalonia.PolarChart.HoveredPointsChangedCommandProperty, avaloniaProperty, bindingMode, converter, overrideView);
...
=> control._setEx(LiveChartsCore.SkiaSharpView.Avalonia.PolarChart.HoveredPointsChangedCommandProperty, ps, () => control.HoveredPointsChangedCommand = converter.TryConvert(value), bindingMode, converter, bindingSource);
...
public static T OnMeasuring<T>(this T control, Action<LiveChartsCore.Kernel.Sketches.IChartView> action) where T : LiveChartsCore.SkiaSharpView.Avalonia.PolarChart  => 
...
/*ActionToEventGenerator*/
public static T OnUpdateStarted<T>(this T control, Action<LiveChartsCore.Kernel.Sketches.IChartView> action) where T : LiveChartsCore.SkiaSharpView.Avalonia.PolarChart  => 
...
/*ActionToEventGenerator*/
public static T OnUpdateFinished<T>(this T control, Action<LiveChartsCore.Kernel.Sketches.IChartView> action) where T : LiveChartsCore.SkiaSharpView.Avalonia.PolarChart  => 
...
/*ActionToEventGenerator*/
public static T OnVisualElementsPointerDown<T>(this T control, Action<LiveChartsCore.Kernel.Sketches.IChartView, LiveChartsCore.Kernel.Events.VisualElementsEventArgs> action) where T : LiveChartsCore.SkiaSharpView.Avalonia.PolarChart  => 
