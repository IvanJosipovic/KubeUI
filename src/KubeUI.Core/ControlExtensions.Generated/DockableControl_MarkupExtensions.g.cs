...
public static T TrackingMode<T>(this T control, Dock.Model.Core.TrackingMode value) where T : Dock.Avalonia.Controls.DockableControl 
=> control._set(() => control.TrackingMode = value!);

/*BindFromExpressionSetterGenerator*/
public static T TrackingMode<T>(this T control, Func<Dock.Model.Core.TrackingMode> func, Action<Dock.Model.Core.TrackingMode>? onChanged = null, [CallerArgumentExpression(nameof(func))] string? expression = null) where T : Dock.Avalonia.Controls.DockableControl 
   => control._set(Dock.Avalonia.Controls.DockableControl.TrackingModeProperty!, func, onChanged, expression);

/*MagicalSetterGenerator*/
[Obsolete]
public static T TrackingMode<T>(this T control,Dock.Model.Core.TrackingMode value, BindingMode? bindingMode = null, IValueConverter? converter = null, object? bindingSource = null, [CallerArgumentExpression(nameof(value))] string? ps = null) where T : Dock.Avalonia.Controls.DockableControl 
...
[Obsolete]
public static T TrackingMode<TValue,T>(this T control, TValue value, FuncValueConverter<TValue, Dock.Model.Core.TrackingMode> converter, BindingMode? bindingMode = null, object? bindingSource = null, [CallerArgumentExpression(nameof(value))] string? ps = null) where T : Dock.Avalonia.Controls.DockableControl 
