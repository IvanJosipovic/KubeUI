...
public static T DynamicOverflowOrder<T>(this T control, System.Int32 value) where T : FluentAvalonia.UI.Controls.CommandBarElementContainer 
=> control._set(() => control.DynamicOverflowOrder = value!);

/*BindFromExpressionSetterGenerator*/
public static T DynamicOverflowOrder<T>(this T control, Func<System.Int32> func, Action<System.Int32>? onChanged = null, [CallerArgumentExpression(nameof(func))] string? expression = null) where T : FluentAvalonia.UI.Controls.CommandBarElementContainer 
...
[Obsolete]
public static T DynamicOverflowOrder<T>(this T control,System.Int32 value, BindingMode? bindingMode = null, IValueConverter? converter = null, object? bindingSource = null, [CallerArgumentExpression(nameof(value))] string? ps = null) where T : FluentAvalonia.UI.Controls.CommandBarElementContainer 
...
[Obsolete]
public static T DynamicOverflowOrder<TValue,T>(this T control, TValue value, FuncValueConverter<TValue, System.Int32> converter, BindingMode? bindingMode = null, object? bindingSource = null, [CallerArgumentExpression(nameof(value))] string? ps = null) where T : FluentAvalonia.UI.Controls.CommandBarElementContainer 
...
/*ValueSetterGenerator*/
public static T IsCompact<T>(this T control, System.Boolean value) where T : FluentAvalonia.UI.Controls.CommandBarElementContainer 
=> control._set(() => control.IsCompact = value!);

/*BindFromExpressionSetterGenerator*/
public static T IsCompact<T>(this T control, Func<System.Boolean> func, Action<System.Boolean>? onChanged = null, [CallerArgumentExpression(nameof(func))] string? expression = null) where T : FluentAvalonia.UI.Controls.CommandBarElementContainer 
   => control._set(FluentAvalonia.UI.Controls.CommandBarElementContainer.IsCompactProperty!, func, onChanged, expression);

/*MagicalSetterGenerator*/
[Obsolete]
public static T IsCompact<T>(this T control,System.Boolean value, BindingMode? bindingMode = null, IValueConverter? converter = null, object? bindingSource = null, [CallerArgumentExpression(nameof(value))] string? ps = null) where T : FluentAvalonia.UI.Controls.CommandBarElementContainer 
...
/*MagicalSetterWithConverterGenerator*/
[Obsolete]
public static T IsCompact<TValue,T>(this T control, TValue value, FuncValueConverter<TValue, System.Boolean> converter, BindingMode? bindingMode = null, object? bindingSource = null, [CallerArgumentExpression(nameof(value))] string? ps = null) where T : FluentAvalonia.UI.Controls.CommandBarElementContainer 
