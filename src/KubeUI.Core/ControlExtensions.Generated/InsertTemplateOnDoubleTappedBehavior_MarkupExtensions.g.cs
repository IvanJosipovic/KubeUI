...
public static T DrawingSource<T>(this T control, NodeEditor.Model.IDrawingNode value) where T : NodeEditor.Behaviors.InsertTemplateOnDoubleTappedBehavior 
=> control._set(() => control.DrawingSource = value!);

/*BindFromExpressionSetterGenerator*/
public static T DrawingSource<T>(this T control, Func<NodeEditor.Model.IDrawingNode> func, Action<NodeEditor.Model.IDrawingNode>? onChanged = null, [CallerArgumentExpression(nameof(func))] string? expression = null) where T : NodeEditor.Behaviors.InsertTemplateOnDoubleTappedBehavior 
...
[Obsolete]
public static T DrawingSource<T>(this T control,NodeEditor.Model.IDrawingNode value, BindingMode? bindingMode = null, IValueConverter? converter = null, object? bindingSource = null, [CallerArgumentExpression(nameof(value))] string? ps = null) where T : NodeEditor.Behaviors.InsertTemplateOnDoubleTappedBehavior 
...
[Obsolete]
public static T DrawingSource<TValue,T>(this T control, TValue value, FuncValueConverter<TValue, NodeEditor.Model.IDrawingNode> converter, BindingMode? bindingMode = null, object? bindingSource = null, [CallerArgumentExpression(nameof(value))] string? ps = null) where T : NodeEditor.Behaviors.InsertTemplateOnDoubleTappedBehavior 
