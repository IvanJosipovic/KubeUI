...
public static T ZoomControl<T,TValue>(this T control, TValue value, FuncValueConverter<TValue, NodeEditor.Controls.NodeZoomBorder> converter, BindingMode? bindingMode = null, object? bindingSource = null, [CallerArgumentExpression("value")] string? ps = null) where T : NodeEditor.Controls.Editor
...
/*MagicalSetterWithConverterGenerator*/
public static T DrawingNode<T,TValue>(this T control, TValue value, FuncValueConverter<TValue, NodeEditor.Controls.DrawingNode> converter, BindingMode? bindingMode = null, object? bindingSource = null, [CallerArgumentExpression("value")] string? ps = null) where T : NodeEditor.Controls.Editor
...
/*MagicalSetterWithConverterGenerator*/
public static T AdornerCanvas<T,TValue>(this T control, TValue value, FuncValueConverter<TValue, Avalonia.Controls.Canvas> converter, BindingMode? bindingMode = null, object? bindingSource = null, [CallerArgumentExpression("value")] string? ps = null) where T : NodeEditor.Controls.Editor
