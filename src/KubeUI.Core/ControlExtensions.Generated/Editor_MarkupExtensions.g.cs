...
public static T DrawingSource<T>(this T control, NodeEditor.Model.IDrawingNode value) where T : NodeEditor.Controls.Editor 
=> control._set(() => control.DrawingSource = value!);

/*BindFromExpressionSetterGenerator*/
public static T DrawingSource<T>(this T control, Func<NodeEditor.Model.IDrawingNode> func, Action<NodeEditor.Model.IDrawingNode>? onChanged = null, [CallerArgumentExpression(nameof(func))] string? expression = null) where T : NodeEditor.Controls.Editor 
   => control._set(NodeEditor.Controls.Editor.DrawingSourceProperty!, func, onChanged, expression);

/*MagicalSetterGenerator*/
[Obsolete]
public static T DrawingSource<T>(this T control,NodeEditor.Model.IDrawingNode value, BindingMode? bindingMode = null, IValueConverter? converter = null, object? bindingSource = null, [CallerArgumentExpression(nameof(value))] string? ps = null) where T : NodeEditor.Controls.Editor 
...
[Obsolete]
public static T DrawingSource<TValue,T>(this T control, TValue value, FuncValueConverter<TValue, NodeEditor.Model.IDrawingNode> converter, BindingMode? bindingMode = null, object? bindingSource = null, [CallerArgumentExpression(nameof(value))] string? ps = null) where T : NodeEditor.Controls.Editor 
...
/*ValueSetterGenerator*/
public static T InputSource<T>(this T control, Avalonia.Controls.Control value) where T : NodeEditor.Controls.Editor 
=> control._set(() => control.InputSource = value!);

/*BindFromExpressionSetterGenerator*/
public static T InputSource<T>(this T control, Func<Avalonia.Controls.Control> func, Action<Avalonia.Controls.Control>? onChanged = null, [CallerArgumentExpression(nameof(func))] string? expression = null) where T : NodeEditor.Controls.Editor 
   => control._set(NodeEditor.Controls.Editor.InputSourceProperty!, func, onChanged, expression);

/*MagicalSetterGenerator*/
[Obsolete]
public static T InputSource<T>(this T control,Avalonia.Controls.Control value, BindingMode? bindingMode = null, IValueConverter? converter = null, object? bindingSource = null, [CallerArgumentExpression(nameof(value))] string? ps = null) where T : NodeEditor.Controls.Editor 
...
/*MagicalSetterWithConverterGenerator*/
[Obsolete]
public static T InputSource<TValue,T>(this T control, TValue value, FuncValueConverter<TValue, Avalonia.Controls.Control> converter, BindingMode? bindingMode = null, object? bindingSource = null, [CallerArgumentExpression(nameof(value))] string? ps = null) where T : NodeEditor.Controls.Editor 
...
/*ValueSetterGenerator*/
public static T AdornerCanvas<T>(this T control, Avalonia.Controls.Canvas value) where T : NodeEditor.Controls.Editor 
=> control._set(() => control.AdornerCanvas = value!);

/*BindFromExpressionSetterGenerator*/
public static T AdornerCanvas<T>(this T control, Func<Avalonia.Controls.Canvas> func, Action<Avalonia.Controls.Canvas>? onChanged = null, [CallerArgumentExpression(nameof(func))] string? expression = null) where T : NodeEditor.Controls.Editor 
   => control._set(NodeEditor.Controls.Editor.AdornerCanvasProperty!, func, onChanged, expression);

/*MagicalSetterGenerator*/
[Obsolete]
public static T AdornerCanvas<T>(this T control,Avalonia.Controls.Canvas value, BindingMode? bindingMode = null, IValueConverter? converter = null, object? bindingSource = null, [CallerArgumentExpression(nameof(value))] string? ps = null) where T : NodeEditor.Controls.Editor 
...
/*MagicalSetterWithConverterGenerator*/
[Obsolete]
public static T AdornerCanvas<TValue,T>(this T control, TValue value, FuncValueConverter<TValue, Avalonia.Controls.Canvas> converter, BindingMode? bindingMode = null, object? bindingSource = null, [CallerArgumentExpression(nameof(value))] string? ps = null) where T : NodeEditor.Controls.Editor 
...
/*ValueSetterGenerator*/
public static T ZoomControl<T>(this T control, NodeEditor.Controls.NodeZoomBorder value) where T : NodeEditor.Controls.Editor 
=> control._set(() => control.ZoomControl = value!);

/*BindFromExpressionSetterGenerator*/
public static T ZoomControl<T>(this T control, Func<NodeEditor.Controls.NodeZoomBorder> func, Action<NodeEditor.Controls.NodeZoomBorder>? onChanged = null, [CallerArgumentExpression(nameof(func))] string? expression = null) where T : NodeEditor.Controls.Editor 
   => control._set(NodeEditor.Controls.Editor.ZoomControlProperty!, func, onChanged, expression);

/*MagicalSetterGenerator*/
[Obsolete]
public static T ZoomControl<T>(this T control,NodeEditor.Controls.NodeZoomBorder value, BindingMode? bindingMode = null, IValueConverter? converter = null, object? bindingSource = null, [CallerArgumentExpression(nameof(value))] string? ps = null) where T : NodeEditor.Controls.Editor 
...
/*MagicalSetterWithConverterGenerator*/
[Obsolete]
public static T ZoomControl<TValue,T>(this T control, TValue value, FuncValueConverter<TValue, NodeEditor.Controls.NodeZoomBorder> converter, BindingMode? bindingMode = null, object? bindingSource = null, [CallerArgumentExpression(nameof(value))] string? ps = null) where T : NodeEditor.Controls.Editor 
