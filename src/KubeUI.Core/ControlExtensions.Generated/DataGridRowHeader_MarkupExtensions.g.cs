...
public static T SeparatorBrush<T>(this T control, Avalonia.Media.IBrush value) where T : Avalonia.Controls.Primitives.DataGridRowHeader 
=> control._set(() => control.SeparatorBrush = value!);

/*BindFromExpressionSetterGenerator*/
public static T SeparatorBrush<T>(this T control, Func<Avalonia.Media.IBrush> func, Action<Avalonia.Media.IBrush>? onChanged = null, [CallerArgumentExpression(nameof(func))] string? expression = null) where T : Avalonia.Controls.Primitives.DataGridRowHeader 
   => control._set(Avalonia.Controls.Primitives.DataGridRowHeader.SeparatorBrushProperty!, func, onChanged, expression);

/*MagicalSetterGenerator*/
[Obsolete]
public static T SeparatorBrush<T>(this T control,Avalonia.Media.IBrush value, BindingMode? bindingMode = null, IValueConverter? converter = null, object? bindingSource = null, [CallerArgumentExpression(nameof(value))] string? ps = null) where T : Avalonia.Controls.Primitives.DataGridRowHeader 
...
[Obsolete]
public static T SeparatorBrush<TValue,T>(this T control, TValue value, FuncValueConverter<TValue, Avalonia.Media.IBrush> converter, BindingMode? bindingMode = null, object? bindingSource = null, [CallerArgumentExpression(nameof(value))] string? ps = null) where T : Avalonia.Controls.Primitives.DataGridRowHeader 
...
/*ValueSetterGenerator*/
public static T AreSeparatorsVisible<T>(this T control, System.Boolean value) where T : Avalonia.Controls.Primitives.DataGridRowHeader 
=> control._set(() => control.AreSeparatorsVisible = value!);

/*BindFromExpressionSetterGenerator*/
public static T AreSeparatorsVisible<T>(this T control, Func<System.Boolean> func, Action<System.Boolean>? onChanged = null, [CallerArgumentExpression(nameof(func))] string? expression = null) where T : Avalonia.Controls.Primitives.DataGridRowHeader 
   => control._set(Avalonia.Controls.Primitives.DataGridRowHeader.AreSeparatorsVisibleProperty!, func, onChanged, expression);

/*MagicalSetterGenerator*/
[Obsolete]
public static T AreSeparatorsVisible<T>(this T control,System.Boolean value, BindingMode? bindingMode = null, IValueConverter? converter = null, object? bindingSource = null, [CallerArgumentExpression(nameof(value))] string? ps = null) where T : Avalonia.Controls.Primitives.DataGridRowHeader 
...
/*MagicalSetterWithConverterGenerator*/
[Obsolete]
public static T AreSeparatorsVisible<TValue,T>(this T control, TValue value, FuncValueConverter<TValue, System.Boolean> converter, BindingMode? bindingMode = null, object? bindingSource = null, [CallerArgumentExpression(nameof(value))] string? ps = null) where T : Avalonia.Controls.Primitives.DataGridRowHeader 
