...
public static T ActiveMap<T>(this T control, LiveChartsCore.Geo.DrawnMap value) where T : LiveChartsCore.SkiaSharpView.Avalonia.GeoMap 
=> control._set(() => control.ActiveMap = value!);

/*BindFromExpressionSetterGenerator*/
public static T ActiveMap<T>(this T control, Func<LiveChartsCore.Geo.DrawnMap> func, Action<LiveChartsCore.Geo.DrawnMap>? onChanged = null, [CallerArgumentExpression(nameof(func))] string? expression = null) where T : LiveChartsCore.SkiaSharpView.Avalonia.GeoMap 
   => control._set(LiveChartsCore.SkiaSharpView.Avalonia.GeoMap.ActiveMapProperty!, func, onChanged, expression);

/*MagicalSetterGenerator*/
[Obsolete]
public static T ActiveMap<T>(this T control,LiveChartsCore.Geo.DrawnMap value, BindingMode? bindingMode = null, IValueConverter? converter = null, object? bindingSource = null, [CallerArgumentExpression(nameof(value))] string? ps = null) where T : LiveChartsCore.SkiaSharpView.Avalonia.GeoMap 
...
[Obsolete]
public static T ActiveMap<TValue,T>(this T control, TValue value, FuncValueConverter<TValue, LiveChartsCore.Geo.DrawnMap> converter, BindingMode? bindingMode = null, object? bindingSource = null, [CallerArgumentExpression(nameof(value))] string? ps = null) where T : LiveChartsCore.SkiaSharpView.Avalonia.GeoMap 
...
/*ValueSetterGenerator*/
public static T Stroke<T>(this T control, LiveChartsCore.Painting.Paint value) where T : LiveChartsCore.SkiaSharpView.Avalonia.GeoMap 
=> control._set(() => control.Stroke = value!);

/*BindFromExpressionSetterGenerator*/
public static T Stroke<T>(this T control, Func<LiveChartsCore.Painting.Paint> func, Action<LiveChartsCore.Painting.Paint>? onChanged = null, [CallerArgumentExpression(nameof(func))] string? expression = null) where T : LiveChartsCore.SkiaSharpView.Avalonia.GeoMap 
   => control._set(LiveChartsCore.SkiaSharpView.Avalonia.GeoMap.StrokeProperty!, func, onChanged, expression);

/*MagicalSetterGenerator*/
[Obsolete]
public static T Stroke<T>(this T control,LiveChartsCore.Painting.Paint value, BindingMode? bindingMode = null, IValueConverter? converter = null, object? bindingSource = null, [CallerArgumentExpression(nameof(value))] string? ps = null) where T : LiveChartsCore.SkiaSharpView.Avalonia.GeoMap 
...
/*MagicalSetterWithConverterGenerator*/
[Obsolete]
public static T Stroke<TValue,T>(this T control, TValue value, FuncValueConverter<TValue, LiveChartsCore.Painting.Paint> converter, BindingMode? bindingMode = null, object? bindingSource = null, [CallerArgumentExpression(nameof(value))] string? ps = null) where T : LiveChartsCore.SkiaSharpView.Avalonia.GeoMap 
...
/*ValueSetterGenerator*/
public static T Fill<T>(this T control, LiveChartsCore.Painting.Paint value) where T : LiveChartsCore.SkiaSharpView.Avalonia.GeoMap 
=> control._set(() => control.Fill = value!);

/*BindFromExpressionSetterGenerator*/
public static T Fill<T>(this T control, Func<LiveChartsCore.Painting.Paint> func, Action<LiveChartsCore.Painting.Paint>? onChanged = null, [CallerArgumentExpression(nameof(func))] string? expression = null) where T : LiveChartsCore.SkiaSharpView.Avalonia.GeoMap 
   => control._set(LiveChartsCore.SkiaSharpView.Avalonia.GeoMap.FillProperty!, func, onChanged, expression);

/*MagicalSetterGenerator*/
[Obsolete]
public static T Fill<T>(this T control,LiveChartsCore.Painting.Paint value, BindingMode? bindingMode = null, IValueConverter? converter = null, object? bindingSource = null, [CallerArgumentExpression(nameof(value))] string? ps = null) where T : LiveChartsCore.SkiaSharpView.Avalonia.GeoMap 
...
/*MagicalSetterWithConverterGenerator*/
[Obsolete]
public static T Fill<TValue,T>(this T control, TValue value, FuncValueConverter<TValue, LiveChartsCore.Painting.Paint> converter, BindingMode? bindingMode = null, object? bindingSource = null, [CallerArgumentExpression(nameof(value))] string? ps = null) where T : LiveChartsCore.SkiaSharpView.Avalonia.GeoMap 
