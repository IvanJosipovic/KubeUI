...
/*MagicalSetterWithConverterGenerator*/
public static T SyncContext<TValue,T>(this T control, TValue value, FuncValueConverter<TValue, System.Object> converter, BindingMode? bindingMode = null, object? bindingSource = null, [CallerArgumentExpression("value")] string? ps = null) where T : LiveChartsCore.SkiaSharpView.Avalonia.GeoMap 
...
/*MagicalSetterWithConverterGenerator*/
public static T ViewCommand<TValue,T>(this T control, TValue value, FuncValueConverter<TValue, System.Object> converter, BindingMode? bindingMode = null, object? bindingSource = null, [CallerArgumentExpression("value")] string? ps = null) where T : LiveChartsCore.SkiaSharpView.Avalonia.GeoMap 
...
/*MagicalSetterWithConverterGenerator*/
public static T MapProjection<TValue,T>(this T control, TValue value, FuncValueConverter<TValue, LiveChartsCore.Geo.MapProjection> converter, BindingMode? bindingMode = null, object? bindingSource = null, [CallerArgumentExpression("value")] string? ps = null) where T : LiveChartsCore.SkiaSharpView.Avalonia.GeoMap 
