...
{
    public static IServiceCollection AddKubeUIKubernetesInfrastructureServices(this IServiceCollection services)
    {
        ...
        services.AddTransient<ICluster>(sp => sp.GetRequiredService<Cluster>());
        services.AddSingleton<ClusterManager>();
        services.AddSingleton<IClusterCatalog>(sp => sp.GetRequiredService<ClusterManager>());
